...
public partial class StatusQueryWindow : Window {
    ...
    private void ApplyLocalization() {
        ...
        ((DataGridTextColumn)_gridRecords.Columns[12]).Header = T("browser.entry_nianhao");
        ((DataGridTextColumn)_gridRecords.Columns[13]).Header = T("browser.association_nianhao_year");
        ((DataGridTextColumn)_gridRecords.Columns[14]).Header = T("browser.association_range");
        ((DataGridTextColumn)_gridRecords.Columns[15]).Header = T("status_query.last_year");
        ((DataGridTextColumn)_gridRecords.Columns[16]).Header = T("browser.entry_nianhao");
        ((DataGridTextColumn)_gridRecords.Columns[17]).Header = T("browser.association_nianhao_year");
        ((DataGridTextColumn)_gridRecords.Columns[18]).Header = T("browser.association_range");
        ((DataGridTextColumn)_gridRecords.Columns[19]).Header = T("browser.supplement");
        ((DataGridTextColumn)_gridRecords.Columns[20]).Header = T("browser.source_title");
        ((DataGridTextColumn)_gridRecords.Columns[21]).Header = T("browser.address_pages");
        ((DataGridTextColumn)_gridRecords.Columns[22]).Header = T("browser.grid_index_address");
        ((DataGridTextColumn)_gridRecords.Columns[23]).Header = "X";
        ((DataGridTextColumn)_gridRecords.Columns[24]).Header = "Y";
        ((DataGridTextColumn)_gridRecords.Columns[25]).Header = T("browser.notes");

...
public partial class StatusQueryWindow : Window {
    ...
    private void ApplyLocalization() {
        ...
        ((DataGridTextColumn)_gridRecords.Columns[9]).Header = T("browser.address_sequence");
        ((DataGridTextColumn)_gridRecords.Columns[10]).Header = T("browser.status_name");
        ((DataGridTextColumn)_gridRecords.Columns[11]).Header = T("status_query.status_code");
        ((DataGridTextColumn)_gridRecords.Columns[12]).Header = T("status_query.first_year");
        ((DataGridTextColumn)_gridRecords.Columns[13]).Header = T("status_query.nianhao_code");
        ((DataGridTextColumn)_gridRecords.Columns[14]).Header = T("browser.entry_nianhao");
        ((DataGridTextColumn)_gridRecords.Columns[15]).Header = T("status_query.nianhao_pinyin");
        ((DataGridTextColumn)_gridRecords.Columns[16]).Header = T("browser.association_nianhao_year");
        ((DataGridTextColumn)_gridRecords.Columns[17]).Header = T("status_query.range_code");
        ((DataGridTextColumn)_gridRecords.Columns[18]).Header = T("status_query.range_desc");
        ((DataGridTextColumn)_gridRecords.Columns[19]).Header = T("browser.association_range");
        ((DataGridTextColumn)_gridRecords.Columns[20]).Header = T("status_query.last_year");
        ((DataGridTextColumn)_gridRecords.Columns[21]).Header = T("status_query.nianhao_code");
        ((DataGridTextColumn)_gridRecords.Columns[22]).Header = T("browser.entry_nianhao");
        ((DataGridTextColumn)_gridRecords.Columns[23]).Header = T("status_query.nianhao_pinyin");
        ((DataGridTextColumn)_gridRecords.Columns[24]).Header = T("browser.association_nianhao_year");
        ((DataGridTextColumn)_gridRecords.Columns[25]).Header = T("status_query.range_code");
        ((DataGridTextColumn)_gridRecords.Columns[26]).Header = T("status_query.range_desc");
        ((DataGridTextColumn)_gridRecords.Columns[27]).Header = T("browser.association_range");
        ((DataGridTextColumn)_gridRecords.Columns[28]).Header = T("browser.supplement");
        ((DataGridTextColumn)_gridRecords.Columns[29]).Header = T("status_query.source_id");
        ((DataGridTextColumn)_gridRecords.Columns[30]).Header = T("browser.source_title");
        ((DataGridTextColumn)_gridRecords.Columns[31]).Header = T("browser.address_pages");
        ((DataGridTextColumn)_gridRecords.Columns[32]).Header = T("browser.grid_index_address");
        ((DataGridTextColumn)_gridRecords.Columns[33]).Header = "X";
        ((DataGridTextColumn)_gridRecords.Columns[34]).Header = "Y";
        ((DataGridTextColumn)_gridRecords.Columns[35]).Header = T("browser.notes");

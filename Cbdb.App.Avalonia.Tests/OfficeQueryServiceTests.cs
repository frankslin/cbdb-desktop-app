...
""");
            ...
            Assert.Equal("臨安; 福州", person.OfficeAddress);
    ...
    [Fact]
    public async Task QueryAsync_PeopleAggregate_SummarizesMultipleOfficePlacesWithOverflowCount() {
        var sqlitePath = CreateTempSqlitePath();
...
""");
            ...
            var person = Assert.Single(result.People);
            Assert.Equal("臨安; 福州 (+1 more)", person.OfficeAddress);
            Assert.Equal(3, person.OfficePlaceCount);
        } finally {
            TryDelete(sqlitePath);
        }
    }
...
""");
    ...
    [Fact]
    public async Task QueryAsync_OfficeYearRange_IncludesOverlappingTenures() {
        var sqlitePath = CreateTempSqlitePath();
...
INSERT INTO OFFICE_CODES VALUES (100, 1, 'zhi zhou', '知州', 'Prefect');
INSERT INTO POSTED_TO_OFFICE_DATA VALUES
    (1, 100, 1000, 1, 1065, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1072, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1),
    (2, 100, 1001, 1, 1081, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1085, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1);
""");
    ...
    [Fact]
    public async Task QueryAsync_OfficeYearRange_UsesAvailableBoundaryWhenOnlyOneYearIsPresent() {
        var sqlitePath = CreateTempSqlitePath();
...
INSERT INTO BIOG_MAIN VALUES
    (1, 'A', '甲', NULL, NULL, NULL, NULL, NULL, NULL, 1080, 1, NULL, NULL, 0, NULL),
    (2, 'B', '乙', NULL, NULL, NULL, NULL, NULL, NULL, 1080, 1, NULL, NULL, 0, NULL),
    (3, 'C', '丙', NULL, NULL, NULL, NULL, NULL, NULL, 1080, 1, NULL, NULL, 0, NULL);
INSERT INTO OFFICE_CODES VALUES (100, 1, 'zhi zhou', '知州', 'Prefect');
INSERT INTO POSTED_TO_OFFICE_DATA VALUES
    (1, 100, 1000, 1, 1075, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1),
    (2, 100, 1001, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1078, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1),
    (3, 100, 1002, 1, 1085, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1);
""");
            ...
            Assert.Equal(new[] { 1, 2 }, result.Records.Select(record => record.PersonId).OrderBy(id => id).ToArray());
            Assert.Equal(new[] { 1, 2 }, result.People.Select(person => person.PersonId).OrderBy(id => id).ToArray());
        } finally {
            TryDelete(sqlitePath);
        }
    }

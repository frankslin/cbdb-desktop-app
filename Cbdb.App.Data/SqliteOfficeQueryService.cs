...
SELECT
    ...
    COALESCE(posting_dy.c_dynasty_chn, posting_dy.c_dynasty) AS posting_dynasty,
    b.c_index_addr_id,
    ...
    fy_nh.c_nianhao_pin AS first_nianhao_pinyin,
    pto.c_fy_nh_year,
    pto.c_fy_range,
    fy_range.c_range AS first_range_desc,
    ...
    fy_gz.c_ganzhi_py AS first_ganzhi_pinyin,
    pto.c_lastyear,
    pto.c_ly_nh_code,
    COALESCE(ly_nh.c_nianhao_chn, ly_nh.c_nianhao_pin) AS last_nianhao,
    ly_nh.c_nianhao_pin AS last_nianhao_pinyin,
    pto.c_ly_nh_year,
    pto.c_ly_range,
    ly_range.c_range AS last_range_desc,
    ...
    ly_gz.c_ganzhi_py AS last_ganzhi_pinyin,
    pto.c_inst_code,
    pto.c_inst_name_code,
...
LEFT JOIN DYNASTIES posting_dy ON posting_dy.c_dy = pto.c_dy
...
""";
        ...
        while (await reader.ReadAsync(cancellationToken)) {
            records.Add(new OfficeQueryRecord(
                ...
                PostingDynasty: reader.IsDBNull(7) ? null : reader.GetString(7),
                IndexAddressId: reader.IsDBNull(8) ? null : reader.GetInt32(8),
                IndexAddress: reader.IsDBNull(9) ? null : reader.GetString(9),
                IndexAddressType: reader.IsDBNull(10) ? null : reader.GetString(10),
                PostingId: reader.GetInt32(11),
                Sequence: reader.IsDBNull(12) ? 0 : reader.GetInt32(12),
                OfficeCode: reader.IsDBNull(13) ? string.Empty : reader.GetString(13),
                Office: reader.IsDBNull(14) ? null : reader.GetString(14),
                AppointmentCode: reader.IsDBNull(15) ? null : reader.GetInt32(15),
                AppointmentType: reader.IsDBNull(16) ? null : reader.GetString(16),
                AssumeOfficeCode: reader.IsDBNull(17) ? null : reader.GetInt32(17),
                AssumeOffice: reader.IsDBNull(18) ? null : reader.GetString(18),
                OfficeCategoryId: reader.IsDBNull(19) ? null : reader.GetInt32(19),
                Category: reader.IsDBNull(20) ? null : reader.GetString(20),
                FirstYear: reader.IsDBNull(21) ? null : reader.GetInt32(21),
                FirstNianhaoCode: reader.IsDBNull(22) ? null : reader.GetInt32(22),
                FirstNianhao: reader.IsDBNull(23) ? null : reader.GetString(23),
                FirstNianhaoPinyin: reader.IsDBNull(24) ? null : reader.GetString(24),
                FirstNianhaoYear: reader.IsDBNull(25) ? null : reader.GetInt32(25),
                FirstRangeCode: reader.IsDBNull(26) ? null : reader.GetInt32(26),
                FirstRangeDesc: reader.IsDBNull(27) ? null : reader.GetString(27),
                FirstRange: reader.IsDBNull(28) ? null : reader.GetString(28),
                FirstMonth: reader.IsDBNull(29) ? null : reader.GetInt32(29),
                FirstIntercalary: reader.IsDBNull(30) ? null : reader.GetInt32(30) == 1,
                FirstDay: reader.IsDBNull(31) ? null : reader.GetInt32(31),
                FirstGanzhiCode: reader.IsDBNull(32) ? null : reader.GetInt32(32),
                FirstGanzhi: reader.IsDBNull(33) ? null : reader.GetString(33),
                FirstGanzhiPinyin: reader.IsDBNull(34) ? null : reader.GetString(34),
                LastYear: reader.IsDBNull(35) ? null : reader.GetInt32(35),
                LastNianhaoCode: reader.IsDBNull(36) ? null : reader.GetInt32(36),
                LastNianhao: reader.IsDBNull(37) ? null : reader.GetString(37),
                LastNianhaoPinyin: reader.IsDBNull(38) ? null : reader.GetString(38),
                LastNianhaoYear: reader.IsDBNull(39) ? null : reader.GetInt32(39),
                LastRangeCode: reader.IsDBNull(40) ? null : reader.GetInt32(40),
                LastRangeDesc: reader.IsDBNull(41) ? null : reader.GetString(41),
                LastRange: reader.IsDBNull(42) ? null : reader.GetString(42),
                LastMonth: reader.IsDBNull(43) ? null : reader.GetInt32(43),
                LastIntercalary: reader.IsDBNull(44) ? null : reader.GetInt32(44) == 1,
                LastDay: reader.IsDBNull(45) ? null : reader.GetInt32(45),
                LastGanzhiCode: reader.IsDBNull(46) ? null : reader.GetInt32(46),
                LastGanzhi: reader.IsDBNull(47) ? null : reader.GetString(47),
                LastGanzhiPinyin: reader.IsDBNull(48) ? null : reader.GetString(48),
                InstitutionCode: reader.IsDBNull(49) ? null : reader.GetInt32(49),
                InstitutionNameCode: reader.IsDBNull(50) ? null : reader.GetInt32(50),
                Institution: reader.IsDBNull(51) ? null : reader.GetString(51),
                OfficeAddressId: reader.IsDBNull(52) ? null : reader.GetInt32(52),
                OfficeAddress: reader.IsDBNull(53) ? null : reader.GetString(53),

...
ORDER BY ad.c_assoc_first_year, ad.c_sequence, ad.c_assoc_code, ad.c_assoc_id;";
        ...
        while (await reader.ReadAsync(cancellationToken)) {
            items.Add(new PersonAssociationItem(
                ...
                AssociatePersonId: reader.IsDBNull(2) ? null : reader.GetInt32(2),
                AssociateNameChn: reader.IsDBNull(3) ? null : reader.GetString(3),
                AssociateName: reader.IsDBNull(4) ? null : reader.GetString(4),
                Association: JoinDisplay(reader.IsDBNull(5) ? null : reader.GetString(5), reader.IsDBNull(6) ? null : reader.GetString(6)),
                Kinship: JoinDisplay(reader.IsDBNull(7) ? null : reader.GetString(7), reader.IsDBNull(8) ? null : reader.GetString(8)),
                KinPersonId: reader.IsDBNull(9) ? null : reader.GetInt32(9),
                KinNameChn: reader.IsDBNull(10) ? null : reader.GetString(10),
                KinName: reader.IsDBNull(11) ? null : reader.GetString(11),
                AssociateKinship: JoinDisplay(reader.IsDBNull(12) ? null : reader.GetString(12), reader.IsDBNull(13) ? null : reader.GetString(13)),
                AssociateKinPersonId: reader.IsDBNull(14) ? null : reader.GetInt32(14),
                AssociateKinNameChn: reader.IsDBNull(15) ? null : reader.GetString(15),
                AssociateKinName: reader.IsDBNull(16) ? null : reader.GetString(16),
                ClaimerPersonId: reader.IsDBNull(17) ? null : reader.GetInt32(17),
                ClaimerNameChn: reader.IsDBNull(18) ? null : reader.GetString(18),
                ClaimerName: reader.IsDBNull(19) ? null : reader.GetString(19),
                AddressNameChn: reader.IsDBNull(20) ? null : reader.GetString(20),
                AddressName: reader.IsDBNull(21) ? null : reader.GetString(21),
                Year: reader.IsDBNull(22) ? null : reader.GetInt32(22),
                Nianhao: JoinDisplay(reader.IsDBNull(23) ? null : reader.GetString(23), reader.IsDBNull(24) ? null : reader.GetString(24)),
                NianhaoYear: reader.IsDBNull(25) ? null : reader.GetInt32(25),
                Month: reader.IsDBNull(26) ? null : reader.GetInt32(26),
                Intercalary: reader.IsDBNull(27) ? null : reader.GetInt32(27) == 1,
                Day: reader.IsDBNull(28) ? null : reader.GetInt32(28),
                Ganzhi: JoinDisplay(reader.IsDBNull(29) ? null : reader.GetString(29), reader.IsDBNull(30) ? null : reader.GetString(30)),
                Range: JoinDisplay(reader.IsDBNull(31) ? null : reader.GetString(31), reader.IsDBNull(32) ? null : reader.GetString(32)),
                TopicChn: reader.IsDBNull(33) ? null : reader.GetString(33),
                Topic: reader.IsDBNull(34) ? null : reader.GetString(34),
                InstitutionNameChn: reader.IsDBNull(35) ? null : reader.GetString(35),
                InstitutionName: reader.IsDBNull(36) ? null : reader.GetString(36),
                OccasionChn: reader.IsDBNull(37) ? null : reader.GetString(37),
                Occasion: reader.IsDBNull(38) ? null : reader.GetString(38),
                LiteraryGenreChn: reader.IsDBNull(39) ? null : reader.GetString(39),
                LiteraryGenre: reader.IsDBNull(40) ? null : reader.GetString(40),
                TextTitle: reader.IsDBNull(41) ? null : reader.GetString(41),
                SourceTitleChn: reader.IsDBNull(42) ? null : reader.GetString(42),
                SourceTitle: reader.IsDBNull(43) ? null : reader.GetString(43),
                Pages: reader.IsDBNull(44) ? null : reader.GetString(44),
                Notes: reader.IsDBNull(45) ? null : reader.GetString(45)
            ));
        }

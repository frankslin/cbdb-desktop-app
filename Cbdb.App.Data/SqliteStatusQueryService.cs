...
SELECT
    ...
    nh1.c_nianhao_pin AS first_nianhao_pinyin,
    sd.c_fy_nh_year,
    sd.c_fy_range,
    yr1.c_range AS first_range_desc,
    COALESCE(yr1.c_range_chn, yr1.c_range) AS first_range,
    sd.c_lastyear,
    sd.c_ly_nh_code,
    COALESCE(nh2.c_nianhao_chn, nh2.c_nianhao_pin) AS last_nianhao,
    nh2.c_nianhao_pin AS last_nianhao_pinyin,
    sd.c_ly_nh_year,
    sd.c_ly_range,
    yr2.c_range AS last_range_desc,
...
""";
        ...
        while (await reader.ReadAsync(cancellationToken)) {
            records.Add(new StatusQueryRecord(
                ...
                FirstNianhaoCode: reader.IsDBNull(16) ? null : reader.GetInt32(16),
                FirstNianhao: reader.IsDBNull(17) ? null : reader.GetString(17),
                FirstNianhaoPinyin: reader.IsDBNull(18) ? null : reader.GetString(18),
                FirstNianhaoYear: reader.IsDBNull(19) ? null : reader.GetInt32(19),
                FirstRangeCode: reader.IsDBNull(20) ? null : reader.GetInt32(20),
                FirstRangeDesc: reader.IsDBNull(21) ? null : reader.GetString(21),
                FirstRange: reader.IsDBNull(22) ? null : reader.GetString(22),
                LastYear: reader.IsDBNull(23) ? null : reader.GetInt32(23),
                LastNianhaoCode: reader.IsDBNull(24) ? null : reader.GetInt32(24),
                LastNianhao: reader.IsDBNull(25) ? null : reader.GetString(25),
                LastNianhaoPinyin: reader.IsDBNull(26) ? null : reader.GetString(26),
                LastNianhaoYear: reader.IsDBNull(27) ? null : reader.GetInt32(27),
                LastRangeCode: reader.IsDBNull(28) ? null : reader.GetInt32(28),
                LastRangeDesc: reader.IsDBNull(29) ? null : reader.GetString(29),
                LastRange: reader.IsDBNull(30) ? null : reader.GetString(30),
                Supplement: reader.IsDBNull(31) ? null : reader.GetString(31),
                SourceId: reader.IsDBNull(32) ? null : reader.GetInt32(32),
                Source: reader.IsDBNull(33) ? null : reader.GetString(33),
                Pages: reader.IsDBNull(34) ? null : reader.GetString(34),
                Notes: reader.IsDBNull(35) ? null : reader.GetString(35)
            ));
        }
